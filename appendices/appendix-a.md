...
The following constraints are defined for use in the constraints array
in the \*.zoning file in the OZFS data standard.
...
| `units_0bed` | The number of studio (zero-bedroom) units in a building | Number of units |
| `units_1bed` | The number of one-bedroom units in a building | Number of units |
| `units_2bed` | The number of two-bedroom units in a building | Number of units |
| `units_3bed` | The number of three-bedroom units in a building | Number of units |
| `units_4bed` | The number of four-bedroom units in a building | Number of units |
...
| `total_units` | The number of units in a building | Number of units |
