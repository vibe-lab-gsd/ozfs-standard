...
| `unit_0bed` | The number of studio (zero-bedroom) units in a building | Number of units |
| `unit_1bed` | The number of one-bedroom units in a building | Number of units |
| `unit_2bed` | The number of two-bedroom units in a building | Number of units |
| `unit_3bed` | The number of three-bedroom units in a building | Number of units |
| `unit_4bed` | The number of four-bedroom units in a building | Number of units |
