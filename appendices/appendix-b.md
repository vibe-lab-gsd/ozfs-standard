...
The following variables names can be included in expressions within the
constraints and definitions arrays of a \*.zoning file.
...
| `unit_separation` | Building | Taken directly from the `unit_separation` value in the `building_info` array in the \*.bldg file. |
