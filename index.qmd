...
Calls for a “GTFS for zoning” date back at least a decade (link to Andrew Salzberg post). (Presumably) inside individual firms, bespoke JSON or GraphQL schemas now power automated tools and linked formulas. None, however, has been published as a public, versioned specification that cities, researchers, and software vendors can adopt without reinvention.
