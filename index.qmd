...
Dallas Agricultural District: "Minimum front yard is 50 feet."
...
Cockrell Hill Single-Family District: "No structure shall be closer to a side or rear lot line than five feet or a distance equal to 10% of the front footage of the lot, whichever distance shall be greater"
...
Fort Worth Height Exceptions: the height of a building in the “A” through “F” districts may be increased when the front, side and rear yard dimensions are each increased above the minimum requirements by one foot for each foot such building exceeds the height limit of the district in which it is located.
