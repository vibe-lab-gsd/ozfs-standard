...
3. Python-syntax mathematical expressions. Controls may be stored as formulas (MaxHeight = 0.5 * LotDepth), allowing rules that reference parcel or building attributes without manual pre-calculation.
