...
Where startups focused on depth within one city, atlas projects emphasize breadth:
- National Zoning Atlas (NZA) aims to decode zoning and similar regulations nationwide [@national_zoning_atlas_national_2025].  Beginning with a spreadsheet template for Connecticut municipalities [@bronin_how_2021], NZA now uses an internal data entry form [@bronin_how_2023] and hosts an interactive map.  Its controlled workflow has produced the largest publicly viewable corpus of zoning attributes in the United States and inspired regional spinoffs.
- Mercatus Center-funded state and regional atlases publish spreadsheet and GeoJSON exports, illustrating both NZA’s influence and the continuing reliance on tabular structures [@mercatus_center_state_2024; @kahn_nza_2024].
- Metropolitan Area Planning Council (link) and Georgia Tech’s ATL Zoning Explorer (link) demonstrate metro-scale visualisation; Washington, DC’s official 3-D zoning viewer (link) shows public appetite for volumetric displays.
These atlases have advanced comparative research and public transparency, yet their tabular formats cannot easily encode conditional logic (e.g., setbacks dependent on street-fronting width) or divergent local definitions of “height,” “story,” and other key terms.
